...
const createMovieItemTemplate = (resto) => `
          <div class="card">
              ...
              <img src="${CONFIG.BASE_IMAGE_URL}${resto.pictureId}" alt="Restoran Indonesia" >
...
export { createRestoDetailTemplate, createMovieItemTemplate, createLikeRestoButtonTemplate, createUnliekRestoButtonTemplate };
